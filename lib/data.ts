...
export const dataList: WebNavigationListRow[] = [
  ...
  },
  {
    id: '2',
    name: 'baby-ac',
    title: 'babyAC-Predict the babys face by AI',
    content: 'Predict the babys face by AI!',
    url: 'https://baby-ac.com/eng',
    imageUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/baby-ac.png',
    thumbnailUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/baby-ac.png',
  },
  {
    id: '3',
    name: 'chatgot',
...

  {
    ...
    content: ' AI generator coloring pages and free coloring pages about dragon theme for download',
    url: 'https://dragon-coloringpages.com/',
    imageUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/image.png',
    thumbnailUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/image.png',
  },
];
...
export const detailList: WebNavigationDetailData[] = [
  ...
  },
  {
    ...
    title: 'babyAC-Predict the babys face by AI',
    detail:
      '### BabyAC is a web application using AI (StyleGan) to predict and generate baby images. StyleGAN is an extension of a deep learning model called GAN, which is able to learn the characteristics of two images and combine them to generate a new high-resolution image.',
    content:
      'BabyAC is a web application using AI (StyleGan) to predict and generate baby images. StyleGAN is an extension of a deep learning model called GAN, which is able to learn the characteristics of two images and combine them to generate a new high-resolution image.Launched in 2023.Tags:AI,Family',
    url: 'https://baby-ac.com/eng',
    imageUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/baby-ac.png',
    thumbnailUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/baby-ac.png',
    collectionTime: '2024-05-20 00:00:00',
  ...
  {
    name: 'dragon-coloringpage',
    title: 'Dragon coloring pages: AI-generated coloring pages',

    detail: '### Dragon colorinng pages is a AI generator and free coloring pages about dragon for download.',
    content: 'Dragon colorinng pages is a AI generator and free coloring pages about dragon for download.',
    url: 'https://dragon-coloringpages.com',
    imageUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/image.png',
    thumbnailUrl: 'https://hiaitools.s3.us-east-2.amazonaws.com/image.png',
    collectionTime: '2024-05-20 00:00:00',
